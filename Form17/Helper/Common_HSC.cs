                                          ...
                                          <table align='center' border='0' cellpadding='0' cellspacing='0' width='100%'>
                                             <tbody>
                                                <tr>
                                                   ...
                                                   <td width='16' align='left' valign='top' style='border-collapse:collapse;font-weight:normal'>:</td>
                                                   <td align='left' valign='top' style='border-collapse:collapse;font-weight:normal'>                                     "+ Common_HSC.Get_Head_Name(Convert.ToInt32(dt.Rows[0]["Payment_Head"].ToString())) +@"                                     </td>
                                                </tr>
                                             </tbody>
                                          </table>
                                       </td>
